...
*** TODO New evaluator algorithm [3/8]
...
- [ ] Include antecedents in easy/hard determination: naked sets in particular
- [ ] Redo InsightMeasurer with new kinds; don't limit to "playable" kinds
- [ ] See whether it makes sense to skip hard moves with the new definition
- [ ] Assuming it does, redo InsightMeasurer again, and ScanPoints
- [ ] Use the numbers from ScanPoints to rework the algo once again
