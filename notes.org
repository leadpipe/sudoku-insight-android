...
** App/UI cleanups
*** TODO layout bug: replay landscape has its controls jiggle when the 2nd progress circle goes
...
*** DONE Separate getting next puzzle counter from updating the pref
...
*** DONE Make capture reasonably sized on tablets
