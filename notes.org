...
** Bugs
*** DONE Undo to beginning is broken -- the game is being paused before it's applied
...
** Publishing the app
*** DONE Make other graphics for play store
...
** Replay cleanups
*** DONE Add jump forward/jump back buttons
    - land just before trail switches
*** DONE Improve display of insight data
    - show insight count and coverage percentage in the square, along with the
      corresponding border color
    - I guess show them only if no insight display showing in the square
*** TODO Animate insight display
    - for complex implications, this could help the visualization
*** TODO Update the help for replay
