...
*** TODO Revamp info view
    - Just use an html table
    - Use javascript for voting
...
*** TODO Update db schema to handle attempts from other installations
*** TODO Add Recommended Puzzles to the list of built-in collections
*** TODO Consider adding an installation name to prefs, default to Build.PLATFORM or whatever it's called
