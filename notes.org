...
*** TODO The puzzles coming out of the generator seem too hard
    - that is, the ratio of easier to harder seems too low
    - and there are bunches of super hard ones
...
*** DONE Write an appengine app that gathers data from the android app
