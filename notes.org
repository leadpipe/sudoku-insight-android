...
** TODO Display of insights
   - when running, display the insight found for the latest move, plus the error
     that resulted from it.  If no insight is found, show an unfounded assignment.
...
** TODO Add slider corresponding to progress through replay
** TODO Think about animation of insight display
   - for complex implications, this could help the visualization
** TODO Make color of disproof border fade out for long implication chains
   - anything over like 8 insights should be much fainter
