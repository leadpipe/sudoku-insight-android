...
** DONE Change the Skip functionality to just start the next game
...
** DONE Generate a GUID at installation time
...
** DONE Add a title for the replay page
...
** DONE Allow exploration in replay
** DONE Speed up replay playback for "clear" moves
