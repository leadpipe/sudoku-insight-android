...
- Yes.  Yeesh.
- Also, sets.
*** TODO Investigate speedup as the puzzle progresses
...
*** TODO Performance improvements [1/4]
- [X] Run profiler
- [-] Fix UnitNumeral so it doesn't consume too many resources
  - [X] Make UnitNumeral enum-like
  - [X] Add UnitNumSet
  - [ ] Use UnitNumeral in Marks
  - [ ] Use UnitNumSet in Insight
  - [X] Unit tests
- [ ] Run profiler again
